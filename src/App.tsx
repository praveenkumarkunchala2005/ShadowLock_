      ...
      <div className="grid min-h-[140px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
        ...
        >
          <path
            ...
            stroke="currentColor"
            strokeWidth="5" // Corrected to camelCase
              ...
              <Route
                ...
                element={
                  !isLoaded ? (
                    ...
                    <Navigate to="/dashboard" /> // Redirect to Duress Mode if password is set
                  ) : (
              ...
              <Route
                ...
                element={
                  !isLoaded ? (
                    ...
                    <Navigate to="/DuressModePasswordSet" replace /> // Redirect to DuressModePasswordSet if duress is not set
                  ) : (
                    <DuressMode />
                  )
                }
